-- db_user: demo
-- submitted_at: 2026-01-27T05:59:32.493Z
-- submitted_at_pt: 2026-01-26T21:59:32.493-08:00
--
-- user_login
...
-- channel_join
INSERT INTO channel_members(username, channel) VALUES ($1, $2) ON CONFLICT DO NOTHING;

-- channel_leave
DELETE FROM channel_members WHERE username = $1 AND channel = $2;
